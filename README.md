...
This repository contains the worked sample app for the [Use docker to provide external services to your Grails app](https://grails.apache.org/guides/grails-docker-external-services/4/guide/index.html) guide on the Apache Grails site.
